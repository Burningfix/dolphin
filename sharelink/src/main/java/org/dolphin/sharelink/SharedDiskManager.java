...
//    }
//
//    private final List<Job.Callback1<List<SharedDisk>>> observers = new LinkedList<Job.Callback1<List<SharedDisk>>>();
//    /**
...
//                .result(new Job.Callback1<List<SharedDisk>>() {
//                            @Override
...
//                .observer(new Job.Callback1<SnifferBean>() {
//                    @Override
//                    public void call(SnifferBean result) {
...
//    }
//
//    public void addObserver(Job.Callback1<List<SharedDisk>> observer) {
//        synchronized (this) {
...
//    }
//
//    public void removeObserver(Job.Callback1<List<SharedDisk>> observer) {
//        synchronized (this) {
